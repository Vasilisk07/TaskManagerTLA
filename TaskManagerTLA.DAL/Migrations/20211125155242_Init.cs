        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSpentHours = table.Column<int>(type: "int", nullable: false),
                    Begin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    End = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GlobalTask", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GlobalTaskId = table.Column<int>(type: "int", nullable: false),
                    SpentHours = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedTask", x => new { x.GlobalTaskId, x.UserId });
                    table.ForeignKey(
                        name: "FK_AssignedTask_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignedTask_GlobalTask_GlobalTaskId",
                        column: x => x.GlobalTaskId,
                        principalTable: "GlobalTask",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
